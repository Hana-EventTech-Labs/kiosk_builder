...
class ProcessingTab(BaseTab):
    ...
    def init_ui(self):
        ...
        process_layout.addRow(bg_label_layout)
        ...
        process_layout.addRow("기본:", background_layout)
        ...
        process_layout.addRow("🇰🇷 한국어:", ko_bg_layout)
        ...
        process_layout.addRow("🇺🇸 English:", en_bg_layout)
